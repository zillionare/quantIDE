        ...
        return DivCentered(
            Card(
                ...
                CardBody(
                    ...
                    Form(
                        LabelInput("用户名", name="username", placeholder="请输入用户名", required=True, autofocus=True),
                        LabelInput("密码", name="password", type="password", placeholder="请输入密码", required=True),
                ...
                CardFooter(
                    DivCentered(
                        P("默认账户: admin / admin123", cls="text-sm text-muted-foreground")
                    )
                ),
                cls="w-full max-w-sm"
            ),
