...
class AuthManager:
    ...
    def register_routes(self, app, prefix='/auth', include_admin=False, allow_custom_login=False):
        """
        ...
        """
        return self.route_handler.register_all(app, prefix, include_admin=include_admin, allow_custom_login=allow_custom_login)
